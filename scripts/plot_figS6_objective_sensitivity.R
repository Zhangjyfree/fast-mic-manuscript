#!/usr/bin/env Rscript
# plot_figS6_objective_sensitivity.R   (Supplementary Figure S6)
#
...
# Output: results/figures_paper/figS6_objective_sensitivity.{pdf,png,tiff}
...
save_one <- function(ext, dev=NULL) {
  fp <- file.path(OUTDIR, paste0("figS6_objective_sensitivity.", ext))
...
cat("Saved figS6_objective_sensitivity (PDF/PNG/TIFF) to", OUTDIR, "\n")
