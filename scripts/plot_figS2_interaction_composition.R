#!/usr/bin/env Rscript
# =============================================================================
# plot_figS2_interaction_composition.R   (Supplementary Figure S2)
# -----------------------------------------------------------------------------
...
figS2 <- ggplot(comp, aes(level_idx, frac, fill = interaction_type)) +
...
ggsave(file.path(OUTDIR, "figS2_interaction_composition.tiff"), figS2,
       width = FIG_W, height = FIG_H, dpi = FIG_DPI,
       compression = "lzw", device = "tiff")
ggsave(file.path(OUTDIR, "figS2_interaction_composition.pdf"), figS2,
       width = FIG_W, height = FIG_H, device = cairo_pdf)
ggsave(file.path(OUTDIR, "figS2_interaction_composition.png"), figS2,
       width = FIG_W, height = FIG_H, dpi = FIG_DPI)

cat("Saved figS2_interaction_composition (TIFF/PDF/PNG) to", OUTDIR, "\n")
