#!/usr/bin/env Rscript
# =============================================================================
# plot_figS2_benefit_landscape.R   (Supplementary Figure S2)
# -----------------------------------------------------------------------------
...
ggsave(file.path(OUTDIR, "figS2_benefit_landscape.tiff"), figS2,
       width = FIG_W, height = FIG_H, dpi = FIG_DPI,
       compression = "lzw", device = "tiff")
ggsave(file.path(OUTDIR, "figS2_benefit_landscape.pdf"), figS2,
       width = FIG_W, height = FIG_H, device = cairo_pdf)
ggsave(file.path(OUTDIR, "figS2_benefit_landscape.png"), figS2,
       width = FIG_W, height = FIG_H, dpi = FIG_DPI)

cat("Saved figS2_benefit_landscape (TIFF/PDF/PNG) to", OUTDIR, "\n")
